...
def test_make_rmse(db_session, gsp_yields, forecast_values_latest, datetime_interval):
    value, n = make_rmse_one_gsp(session=db_session, datetime_interval=datetime_interval, gsp_id=1, model_name="cnn")
...
def test_make_rmse_all_gsp(db_session, gsp_yields, forecast_values_latest, datetime_interval):
    value, n = make_rmse_all_gsp(session=db_session, datetime_interval=datetime_interval, model_name="cnn")
