from nowcasting_metrics.metrics.rmse import make_rmse_one_gsp, make_rmse, make_rmse_all_gsp
...
def test_make_rmse_all_gsp(db_session, gsp_yields, forecast_values_latest, datetime_interval):
    ...
    value, n = make_rmse_all_gsp(session=db_session, datetime_interval=datetime_interval)
